...
function create(){
  ...
  this.physics.add.overlap(this.player, this.collectables, playerCollect, null, this);
  this.physics.add.overlap(this.player, this.end_goals, endLevel, null, this);
